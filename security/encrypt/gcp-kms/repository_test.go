...
func TestGCPRepositoryErrorBranches(t *testing.T) {
	...
	if _, err := ensureGCPVersion(context.Background(), fakeGCPClient{
		...
		createCryptoKeyVersionFn: func(context.Context, *kmspb.CreateCryptoKeyVersionRequest) (*kmspb.CryptoKeyVersion, error) { return &kmspb.CryptoKeyVersion{}, nil },
		...
		asymmetricSignFn:         func(context.Context, *kmspb.AsymmetricSignRequest) (*kmspb.AsymmetricSignResponse, error) { return nil, nil },
		asymmetricDecryptFn:      func(context.Context, *kmspb.AsymmetricDecryptRequest) (*kmspb.AsymmetricDecryptResponse, error) { return nil, nil },
	...
	if _, err := fetchGCPPublicKey(context.Background(), fakeGCPClient{
		getPublicKeyFn:           func(context.Context, *kmspb.GetPublicKeyRequest) (*kmspb.PublicKey, error) { return &kmspb.PublicKey{Pem: "bad pem"}, nil },
		createCryptoKeyFn:        func(context.Context, *kmspb.CreateCryptoKeyRequest) (*kmspb.CryptoKey, error) { return nil, nil },
		createCryptoKeyVersionFn: func(context.Context, *kmspb.CreateCryptoKeyVersionRequest) (*kmspb.CryptoKeyVersion, error) { return nil, nil },
		encryptFn:                func(context.Context, *kmspb.EncryptRequest) (*kmspb.EncryptResponse, error) { return nil, nil },
		decryptFn:                func(context.Context, *kmspb.DecryptRequest) (*kmspb.DecryptResponse, error) { return nil, nil },
		asymmetricSignFn:         func(context.Context, *kmspb.AsymmetricSignRequest) (*kmspb.AsymmetricSignResponse, error) { return nil, nil },
		asymmetricDecryptFn:      func(context.Context, *kmspb.AsymmetricDecryptRequest) (*kmspb.AsymmetricDecryptResponse, error) { return nil, nil },
...
func TestGCPClientAdapterMethodsEnterWrappedCalls(t *testing.T) {
	...
	assertGCPPanic(t, func() { _, _ = adapter.CreateCryptoKeyVersion(context.Background(), &kmspb.CreateCryptoKeyVersionRequest{}) })
